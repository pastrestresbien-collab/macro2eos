...
générateur rend ensuite — 38 intentions, 198 cas de traduction + 12 cas de correction,
...
| **B — écrire le traducteur NL** | 🚧 v0.20 — 38 intentions, 198 + 12 tests, 213 invariants, multi-commandes et paramètres génériques. Déterministe, sans IA à l'exécution (voir ci-dessous) |
