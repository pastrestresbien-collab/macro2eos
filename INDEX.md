...
| Analyse du layout TouchOSC officiel ETC pour Eos (5 pages : Keyboard, Attributes, Groups, Fader, Cues) — contrôles, positions, adresses OSC décodées | [`reference/touchosc/ANALYSE_LAYOUT_TOUCHOSC.md`](reference/touchosc/ANALYSE_LAYOUT_TOUCHOSC.md) | ✅ Layout `.touchosc` source inclus, décodage base64 intégral, patterns OSC par page |
